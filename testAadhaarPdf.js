...
async function testProcessAadhaarPdf() {
  try {
    ...
    const base64Image = await processAadhaarPdf(base64Pdf, pdfPassword, cropConfigBack);
    
    // Save the resulting image to verify
    const outputImagePath = path.join(__dirname, 'adhaarDownload/temp/output-image.jpg');
